...
The forward variance of $$\ln F(t,T_i)$$ is $$ \int_{t_m}^{t_n}[ e^{-2k(T_i-t)} \sigma_s^2(t)) + ( 1 - e^{-2k(T_i-t)}) \sigma_l^2(t_n))dt + 2 e^{-2k(T_i-t)}( 1- e^{-2k(T_i-t)}) \sigma_s(t) \sigma_l \rho] dt $$
